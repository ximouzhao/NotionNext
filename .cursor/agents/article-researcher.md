...
2. Inspect relevant existing Notion pages for overlap, inconsistent terminology, and link targets. List only pages that share this topic or a real boundary cut—do not default-add the golden-sample article as related reading.
